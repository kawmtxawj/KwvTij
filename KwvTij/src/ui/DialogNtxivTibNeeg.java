...
/**
 * Dialog to add a Txiv
 * @author Kao Vang
 *
 */
public class DialogNtxivTibNeeg extends JDialog{
	...
	private JButton button_ntxiv;
	
	/**
	 * Contructor with a frame that the dialog will dispaly on
	 * @param frame - the frame dialog will display on
	 */
	public DialogNtxivTibNeeg(Control_UI con_ui) {
		this.cltr_ui = con_ui;
		
		this.setTitle("Ntxiv Tib Neeg");
		...
		button_ntxiv = new JButton("Ntxiv");
		button_ntxiv.addActionListener(listener);
		panel_button.add(button_ntxiv);
	...
	private class ButtonListener implements ActionListener {
		  public void actionPerformed (ActionEvent event) {
		    ...
		    if (source == button_ntxiv) {
		    	...
		    	cltr_ui.ntxivTibNeeg(tn, npe, xeem, tebChawYug);
		        hideDial();
		        
		        /* Refresh the family tree chart */
		        cltr_ui.getFrame().refresh_family_tree();
		    }
		  }
	 }
